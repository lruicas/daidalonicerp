...
const Header = () => {
  ...
  return (
    <header
      className="px-4 sm:px-8 py-4 sm:py-5 flex items-center justify-between gap-3"
      style={{ background: "linear-gradient(135deg, hsl(168, 62%, 55%), hsl(40, 95%, 62%), hsl(340, 82%, 65%))" }}
    >
      <h1 className="text-lg sm:text-2xl font-light tracking-wide text-primary-foreground font-display whitespace-nowrap">
        Daidalonic <span className="font-semibold">ERP</span>
      </h1>

      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        <Badge
          className={`text-xs font-medium border-0 transition-colors duration-300 hidden sm:inline-flex ${
            canEdit
